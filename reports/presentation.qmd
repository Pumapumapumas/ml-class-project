...
Examples at right: Clean (best case) and Damaged (worst case) for contrast.
:::

::: {.column width="40%"}
![Clean](figures/corpus/quality_examples/clean.jpg){width="95%"}

![Damaged](figures/corpus/quality_examples/damaged.jpg){width="95%"}
:::
:::
...
| Model | Best | Mean CER |
|-------|------|---------:|
| Sonnet | grayscale-soft¹ | 0.272 |
| Tesseract | grayscale-soft¹ | 0.369 |
| Gemini Flash | raw / deskew | 0.56 |

¹ deskew + denoise + CLAHE contrast, no binarize.

**Two patterns:**

- **Binarize universally destroys** — every binarize cell loses. Tesseract -21pp worst.
- **Other stages are model-dependent** — helps Sonnet & Tesseract, hurts Gemini Flash.
:::
