...
## Finding 1: Binarization universally hurts; other stages are per-model {.smaller}

::: {.columns}
::: {.column width="55%"}
**Per-stage ablation (5 variants × 30 pages):**

| Best variant by model | Mean CER |
|-----------------------|---------:|
| Claude Sonnet — **grayscale_soft** ¹ | 0.272 |
| Tesseract — **grayscale_soft** ¹ | 0.369 |
| Gemini Flash — **raw** | 0.564 |
...
- **Other stages are model-dependent.** Sonnet & Tesseract benefit from grayscale-soft; Gemini Flash is hurt by it.

**Why:** binarize collapses 256 grayscale levels → 2 with 0% mid-tones, stripping the gradient OCR needs.
:::
