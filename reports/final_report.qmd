...
[**TODO: 2-3 paragraphs on Telugu script topology and OCR-specific challenges.** Cover: compound characters, vowel diacritic attachment, historical-printing typographic conventions. Cite a Telugu-OCR survey paper.]

## Vision-language models for OCR

[**TODO: 2 paragraphs on multimodal LLMs and their use for OCR.** Cover: Gemini, Claude, GPT-4o; cite a recent multimodal-OCR survey or position paper.]

## Classical OCR: Tesseract

[**TODO: 1-2 paragraphs on Tesseract 5 architecture, its built-in preprocessing (Otsu binarization, Sauvola local thresholding), and its known limitations on Indic scripts.** Cite the Tesseract paper.]

## LLM-based validation without ground truth

[**TODO: 2 paragraphs on the LLM-as-judge framing. Method A (fluency scoring) and Method B (cross-model agreement) follow established patterns in recent NLP evaluation literature.**]
